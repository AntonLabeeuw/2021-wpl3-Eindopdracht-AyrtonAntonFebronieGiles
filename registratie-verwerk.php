...
if(isset($_POST["submit"])){
    ...
    if(isset($_POST["voornaam"], $_POST["naam"], $_POST["email"], $_POST["telefoon"], $_POST["straat"], $_POST["nummer"], $_POST["postcode"], $_POST["gemeente"], $_POST["soort_gebouw"], $_POST["installatie"], $_POST["datum_installatie"], $_POST["laatste_onderhoud"], $_POST["staat"], $_POST["gebruikersnaam"], $_POST["wachtwoord"])){
        ...
        $nieuweGebruiker = new Gebruiker(null, $_POST["voornaam"], $_POST["naam"], $_POST["gebruikersnaam"], $gehashtWachtwoord, $_POST["email"], $_POST["telefoon"], $_POST["straat"], $_POST["nummer"], $_POST["bus"], $_POST["postcode"], $_POST["gemeente"], $_POST["soort_gebouw"], $_POST["installatie"], $_POST["datum_installatie"], $_POST["laatste_onderhoud"], $_POST["staat"], 0, 000-00-00);
