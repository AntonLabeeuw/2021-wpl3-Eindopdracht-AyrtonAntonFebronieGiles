      ...
      <main>
            ...
            <section class="c-contactgegevens">
                <div class="container">
                    ...
                    <p><?php echo get_theme_mod('setting-contact-p5'); ?></br><a class="c-policy-link" href="mailto:<?php echo get_theme_mod('setting-contact-a'); ?>"><?php echo get_theme_mod('setting-contact-a'); ?></a></p>
                </div>
