<?php get_header(); ?>
        <main>
            <div class="container">
                <h1><?php echo get_theme_mod('setting-privacy-h1.1'); ?></h1>
                <p class="c-policy-bold"><?php echo get_theme_mod('setting-privacy-p.1'); ?></p>
                <h2><?php echo get_theme_mod('setting-privacy-h2.1'); ?></h2>
                <p><?php echo get_theme_mod('setting-privacy-p.2'); ?> <a href="<?php echo get_theme_mod('setting-privacy-link.1'); ?>"  class="c-policy-link"><?php echo get_theme_mod('setting-privacy-text.1'); ?></a> <?php echo get_theme_mod('setting-privacy-p.3'); ?></p>
                <h2><?php echo get_theme_mod('setting-privacy-h2.2'); ?></h2>
                <p><?php echo get_theme_mod('setting-privacy-p.4'); ?> <a href="<?php echo get_theme_mod('setting-privacy-link.2'); ?>" class="c-policy-link"><?php echo get_theme_mod('setting-privacy-text.2'); ?></a> <?php echo get_theme_mod('setting-privacy-p.5'); ?></p>
                <h2><?php echo get_theme_mod('setting-privacy-h2.3'); ?></h2>
                <p><?php echo get_theme_mod('setting-privacy-p.6'); ?> <a href="<?php echo get_theme_mod('setting-privacy-link.3'); ?>" class="c-policy-link"><?php echo get_theme_mod('setting-privacy-text.3'); ?></a>.</p>
                <h2><?php echo get_theme_mod('setting-privacy-h2.4'); ?></h2>
                <p><a href="<?php echo get_theme_mod('setting-privacy-link.4'); ?>" class="c-policy-link"><?php echo get_theme_mod('setting-privacy-text.4'); ?></a> <?php echo get_theme_mod('setting-privacy-p.7'); ?></p>
                <p><?php echo get_theme_mod('setting-privacy-p.8'); ?></p>
                <h2><?php echo get_theme_mod('setting-privacy-h2.5'); ?></h2>
